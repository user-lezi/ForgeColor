...
function colorDistance(c1, c2, mode) {
    switch (mode) {
        case typings_1.ColorDistanceMode.EuclideanRGB:
            return Math.hypot(c1.r - c2.r, c1.g - c2.g, c1.b - c2.b);
        case typings_1.ColorDistanceMode.WeightedRGB:
            const redmean = (c1.r + c2.r) / 2;
            return Math.sqrt((2 + redmean / 256) * Math.pow(c1.r - c2.r, 2) +
                4 * Math.pow(c1.g - c2.g, 2) +
                (2 + (255 - redmean) / 256) * Math.pow(c1.b - c2.b, 2));
        case typings_1.ColorDistanceMode.CIE76: {
            const l1 = rgbToLab(c1);
            const l2 = rgbToLab(c2);
            return Math.hypot(l1.L - l2.L, l1.a - l2.a, l1.b - l2.b);
        }
        case typings_1.ColorDistanceMode.Luminance:
