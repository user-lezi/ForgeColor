...
exports.default = new forgescript_1.NativeFunction({
    ...
    args: [
        ...
        forgescript_1.Arg.optionalEnum(blend_1.BlendMode, "mode", "How to interpolate between colors (default: average)"),
    ...
    async execute(ctx, [steps, format, includeStops, mode, colors]) {
        ...
        try {
            const gradient = (0, gradient_1.generateGradient)(parsed, steps, includeStops == true, mode || blend_1.BlendMode.average);
